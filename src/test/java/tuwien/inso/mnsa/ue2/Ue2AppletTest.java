...
public class Ue2AppletTest {
	...
	public void testSub1() {
		assertAPDUResponse("0x00 " + OxSUB + " 0xb0 0xa1 0x00", "0x0f 0x00", "0x90 0x00"); // b0 -  a1 =  0f
		assertAPDUResponse("0x00 " + OxSUB + " 0xA3 0xA0 0x00", "0x03 0x00", "0x90 0x00"); // a3 -  a0 =  03
		assertAPDUResponse("0x00 " + OxSUB + " 0xf5 0xf4 0x00", "0x01 0x00", "0x90 0x00"); // f5 -  f4 =  01
		assertAPDUResponse("0x00 " + OxSUB + " 0x04 0x06 0x00", "0xfe 0xff", "0x90 0x00"); // 04 -  06 = -02 (0xff 0xfe signed short)
		assertAPDUResponse("0x00 " + OxSUB + " 0xb0 0xb1 0x00", "0xff 0xff", "0x90 0x00"); // b0 -  b1 = -01 (0xff 0xff signed short)
		assertAPDUResponse("0x00 " + OxSUB + " 0xf5 0xf6 0x00", "0xff 0xff", "0x90 0x00"); // f5 -  f6 = -01 (0xff 0xff signed short)
		assertAPDUResponse("0x00 " + OxSUB + " 0x05 0xff 0x00", "0x06 0x00", "0x90 0x00"); // 05 - -01 =  06
	}

	@Test
	public void testMul1() {
		assertAPDUResponse("0x00 " + OxMUL + " 0x00 0xff 0x00", "0x00 0x00", "0x90 0x00"); //  00 *  ff =    00
	...
	private static String Ox(byte b) {
		if(b < 0x10) return "0x0" + Integer.toHexString(b);
		else return "0x" + Integer.toHexString(b);
	}
}
